...
VERSION_PATTERN = (r'^(0|[1-9]\d*)(\.(0|[1-9]\d*)){1,}'  # Allow 2 or more numeric parts
...
def fetch_addon_from_folder(raw_addon_location, target_folder):
    ...
    with zipfile.ZipFile(
        ...
        exclude_files = {'.gitignore', '.DS_Store', 'create_repository.py'}
        for (root, dirs, files) in os.walk(addon_location):
            ...
            # Only add the root if it's not excluded
